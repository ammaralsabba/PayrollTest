...
class hr_loan(models.Model):
    ...
    def _create_payment_entry(self, amount):
        ...
        debit, credit, amount_currency, currency_id = aml_obj.with_context(date=self.date)._compute_amount_fields(amount, self.company_id.currency_id, self.company_id.currency_id, False)
